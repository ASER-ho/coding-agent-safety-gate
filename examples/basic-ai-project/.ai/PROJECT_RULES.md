...
将此文件复制到你自己的项目中。填写你的项目详情。与团队一起审查。
...
- 当 NEXT_TASK.md 批准时编辑 README.md / Edit README.md when approved by NEXT_TASK.md
- 编辑 docs/ 下的文档文件 / Edit documentation files under docs/
- 每个任务后报告证据 / Report evidence after every task

范围外 / Out of scope:

- 生产部署 / Production deployment
- 数据库 schema 变更 / Database schema changes
- 添加第三方服务 / Adding third-party services
...
这些操作需要明确的用户批准。 / These actions require explicit human approval.
