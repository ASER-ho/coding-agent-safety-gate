# Claude Code — Safety Gate Example
...
When using Claude Code or another terminal-based coding agent, the agent must not:
...
Copy this into a Claude Code session after setting up your project files:
